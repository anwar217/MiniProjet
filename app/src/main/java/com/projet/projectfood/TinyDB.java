...
public class TinyDB {
    ...
    public ArrayList<Categorie> getListObject(String key){
        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString(key);
        ArrayList<Categorie> playerList =  new ArrayList<Categorie>();

        for(String jObjString : objStrings){
            Categorie player  = gson.fromJson(jObjString,  Categorie.class);
    ...
    public void putListObject(String key, ArrayList<Categorie> playerList){
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for(Categorie player: playerList){
